              ...
              <div className="flex items-center px-6">
                <Button
                  className={cn(
                    ...
                    plan.highlight &&
                      theme === "classic" &&
                      "relative overflow-hidden bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-semibold py-3 px-6 rounded-lg border border-primary/20",
                  )}
        ...
        >
          <Table className={cn(theme === "classic" && "bg-transparent")}>
            <TableHeader>
              ...
              >
                <TableHead className={firstColWidthVariants({ size })} />
                {plans.map((plan: Plan) => (
                  <TableHead
                    key={plan.id}
                    className={cn(
